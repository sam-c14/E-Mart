    ...
    <div className="bg-pink-500 w-full">
      <ul className="flex w-full px-10 py-3.5 text-white">
        ...
        <li className="flex w-1/2">
          <input
            type="text"
            className="pl-5 py-1 w-11/12 outline-none rounded-s-md"
        ...
        <li className="w-1/6 py-1 rounded-sm flex text-xl items-center text-white gap-5 justify-center bg-teal-500">
